 ...
 *说明：
 * 默认返回的日期时间格式如同：2014-02-02 08:08
 */
//------------------ 样式定义 ---------------------------//
//功能按钮同样样式
...
//------------------ 变量定义 ---------------------------//
var mydate=new Date();
var tiannetYearSt =mydate.getFullYear();//可选择的开始的年份
...
function validTime(tiannetOutObject,endTime){
	   var arr1 = tiannetOutObject.split("-");
